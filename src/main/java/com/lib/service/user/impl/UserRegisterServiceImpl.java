...
public class UserRegisterServiceImpl implements UserRegisterService {
	...
	public void updateEmail(UserInfo user) {
		...
		/// 邮件的内容
		StringBuffer sb = new StringBuffer("点击下面链接更换CAIUSLIB知识库管理系统网站账号，48小时生效，链接只能使用一次</br>");
	...
	public void processregister(String userName, String userPassword, String email,String url) {
		...
		/// 邮件的内容
		StringBuffer sb = new StringBuffer("用户：" + userName + ",您好！<br>欢迎使用CAIUSLIB知识库管理系统，请点击下面链接激活您的帐号<br>");
